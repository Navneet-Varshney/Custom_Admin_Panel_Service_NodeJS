 ...
 */
const initializeServiceToken = async (serviceName = SERVICE_NAMES.ADMIN_PANEL_SERVICE) => {
    try {
 ...
 */
const getServiceToken = async (serviceName = SERVICE_NAMES.ADMIN_PANEL_SERVICE) => {
    try {
 ...
 */
const rotateServiceToken = async (serviceName = SERVICE_NAMES.ADMIN_PANEL_SERVICE) => {
